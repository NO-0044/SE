...
以IOS界面为例，分为用户登录，日程显示，作业实验查询，讨论区，笔记等部分。
  ...
  \iterm登录按钮：点击登录
  \end{itemize}
    \subsubsection{日程日历化显示}
    #ddl.png
    #菜单.png
    \begin{itemize}
  \iterm+按钮：新建日程
  \iterm今天：显示今天待提交的实验或作业
  \iterm日历：显示日历
  \iterm筛选：按指定规则筛选时间
  \iterm点击日程标题：进入作业或实验的具体页面
  \iterm菜单页面：点击选择功能
  \end{itemize}
    \subsubsection{作业实验查询}
    #实验.png
    \begin{itemize}
  \iterm排序方式按钮：选择排序方式
  \iterm-未完成：显示所有未完成任务
  ...
  \iterm查找框：按用户输入关键词搜索
  \iterm点击标题：进入作业或实验的具体页面
  \iterm菜单按钮：查看功能菜单
  #实验2.png
  \iterm DDL：点击跳转到实验日期的日历显示界面
  \iterm实验资料下载：下载本次实验的试验资料
  \iterm提交实验报告：上传本地的实验报告
    \subsubsection{讨论区}
    \end{itemize}
    #讨论区.png
    \begin{itemize}
  \iterm分享：将课程讨论区分享给其他用户或其他软件
  \iterm添加讨论：发布新的主题
  \iterm排序方式：选择不同的排序方式
  \iterm点击讨论主题标题：进入讨论主题详情
  \end{itemize}
    \subsubsection{笔记}
    #笔记编写.png
    \begin{itemize}
  \iterm返回按钮：退出编辑，返回上一级，不保存
  \iterm笔记编写：键盘输入编写内容
  \iterm✔️：编写玩笔记，保存并返回
  \end{itemize}
